...
export class GrupoService {
  ...
  getAllGrupo(): Observable<Grupo[]>{
    return this.http.get<Grupo[]>('https://ciclonext.herokuapp.com/api/v1/grupo/getAll'
    // , this.token
    )
  ...
  getByIdGrupo(id: number): Observable<Grupo>{
    return this.http.get<Grupo>(`https://ciclonext.herokuapp.com/api/v1/grupo/${id}`
    // , this.token
    )
  ...
  postGrupo(grupo: Grupo): Observable<Grupo>{
    return this.http.post<Grupo>('https://ciclonext.herokuapp.com/api/v1/grupo', grupo
    // , this.token
    )
  }
  ...
  deleteGrupo(id: number){
    return this.http.delete(`https://ciclonext.herokuapp.com/api/v1/grupo/${id}`
    // , this.token
    )
  }
